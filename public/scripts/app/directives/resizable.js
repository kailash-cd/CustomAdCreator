define(['angular'],function(angular){
    'use strict';
    var newModule = angular.module('resizable', []);
    newModule.directive('resizable',['$log', function($log) {
        return {
            restrict: 'AE',
            scope: {
                rDirections: "=",
            ...
            link: function(scope, element, attr) {
                ...
                $log.debug("resizeEnable status",scope.resizeEnable);
                  if(scope.resizeEnable) {
                  ...
                  {
                      $log.info("can not drag out side the canvas");
                  }
            }
        }
    }]);
